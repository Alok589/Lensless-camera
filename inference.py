...
plot_name = "inference_"+str(5)+".png"
model = Dense_Unet()
model.load_state_dict(torch.load("/thesis/models_weights/exp_7.pt"))
model.eval()
...
io.show()
plt.savefig(os.path.join("/thesis/inference_plots/", plot_name))
